...
values
  ...
  ( '2024-05-01', '2024-05-01', '2024-05-03', '3',  CURRENT_TIMESTAMP(0), CURRENT_TIMESTAMP(0)),
  ( '2024-06-01', '2024-06-01', '2024-06-03', '3',  CURRENT_TIMESTAMP(0), CURRENT_TIMESTAMP(0)),
  ( '2024-05-01', '2024-07-01', '2024-07-03', '9',  CURRENT_TIMESTAMP(0), CURRENT_TIMESTAMP(0)),
  ( '2024-06-01', '2024-08-01', '2024-08-03', '9',  CURRENT_TIMESTAMP(0), CURRENT_TIMESTAMP(0)),
